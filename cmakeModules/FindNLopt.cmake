...
if(_NLopt_PC_FILE)
	file(STRINGS ${_NLopt_PC_FILE} _NLopt_VERSION_LINE REGEX "Version:")
	list(LENGTH _NLopt_VERSION_LINE _NLopt_VERSION_LINES)
	if(_NLopt_VERSION_LINES EQUAL 1)
		string(REGEX MATCHALL "[0-9]+" _NLopt_VERSION_COMPONENTS ${_NLopt_VERSION_LINE})
		foreach(_NLopt_VERSION_COMPONENT IN LISTS _NLopt_VERSION_COMPONENTS)
			if(DEFINED NLopt_VERSION)
				set(NLopt_VERSION "${NLopt_VERSION}.")
			endif()
			set(NLopt_VERSION "${NLopt_VERSION}${_NLopt_VERSION_COMPONENT}")
		endforeach()
		unset(_NLopt_VERSION_COMPONENT)
		unset(_NLopt_VERSION_COMPONENTS)
	else()
		message(WARNING "Error while parsing NLopt version from '${_NLopt_PC_FILE}': "
			"got ${_NLopt_VERSION_LINES} 'Version' lines instead of 1.")
	endif()
	unset(_NLopt_VERSION_LINE)
	unset(_NLopt_VERSION_LINES)
endif()
