...
# ************************ variables to set ! **************************
	export KPIPI_WORKSPACE="/mnt/disk2/analysis/Kp_Kppipi/PWA" # if you specify here an exisiting directory with ~5GB space you may leave the rest unchanged
	...
	export KPIPI_WORK_DIR="${KPIPI_WORKSPACE}/SET_test/" # work directory containing binned data and calculated amplitudes
	...
	export KPIPI_FIT_DIR="${KPIPI_WORKSPACE}/FIT_test/" # path to the fit directory
