...
void setupBookies() {
  ...
  histnames_neutral.push_back(TString("hMIsobarMC_Kpi")); // Canvas spot 1
  histnames_neutral.push_back(TString("spacer")); // Canvas spot 2
  histnames_neutral.push_back(TString("hGJMC_Kpi")); // Canvas spot 3
  histnames_neutral.push_back(TString("hTYMC_Kpi")); // Canvas spot 4
  histnames_neutral.push_back(TString("hHThetaMC_Kpi")); // Canvas spot 5
  histnames_neutral.push_back(TString("hHPhiMC_Kpi")); // Canvas spot 6
  // charged isobar decay
  histnames_charged.push_back(TString("hMIsobarMC_pipi")); // Canvas spot 1
  histnames_charged.push_back(TString("spacer")); // Canvas spot 2
  histnames_charged.push_back(TString("hGJMC_pipi")); // Canvas spot 3
  histnames_charged.push_back(TString("hTYMC_pipi")); // Canvas spot 4
  histnames_charged.push_back(TString("hHThetaMC_pipi")); // Canvas spot 5
  histnames_charged.push_back(TString("hHPhiMC_pipi")); // Canvas spot 6

  booky_setup_map.insert(std::pair<TString, std::vector<TString> >("Booky_Kpi_isobar", histnames_neutral));
  booky_setup_map.insert(std::pair<TString, std::vector<TString> >("Booky_pipi_isobar", histnames_charged));
}
