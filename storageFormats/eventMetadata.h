...
namespace rpwa {
	...
	// root needs a public default constructor
	  ...
	  private:
		...
		void setBinningVariableRange(const std::string& label, const boundaryType& range);
		void setMultibinBoundaries(const multibinBoundariesType& multibinBoundaries);
		...
		multibinBoundariesType _multibinBoundaries;
