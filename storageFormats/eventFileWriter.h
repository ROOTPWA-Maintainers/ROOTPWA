	...
	class eventFileWriter {
	  ...
	  public:
		...
		bool initialize(TFile&                                                   outputFile,                        // output file to write the data to (user keeps ownership!)
		                ...
		                const multibinBoundariesType&                            multibinBoundaries,                // multibin boundaries with content "label" -> (lowerBound, upperBound) describing which bin these data belong to
