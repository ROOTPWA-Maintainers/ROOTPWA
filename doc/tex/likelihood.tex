...
\refl the reflectivity.  The indices $\cbrk{a}_\refl$ and
$\cbrk{b}_\refl$ enumerate the waves with reflectivity \refl. They
...
%
% From
% these equations is clear that all second derivatives \wrt transition
% amplitudes with different rank index or different reflectivities
% vanish. We therefore only need to consider partial derivatives of
% \cref{likelihood_function_re_deriv,likelihood_function_im_deriv} \wrt
% to the real and imaginary parts of
% $\mathcal{T}_{\doubletilde{a}}^{\tilde{r} \tilde{\refl}}$:
% \begin{align}
%   -\dmd{\ln \mathcal{L}}{2}{{x_{\tilde{a}}^{\tilde{r} \tilde{\refl}}}}{}{{x_{\doubletilde{a}}^{\tilde{r} \tilde{\refl}}}}{}
%   &= \dpd{}{{x_{\doubletilde{a}}^{\tilde{r} \tilde{\refl}}}}
%     \rBrk{-\sum_{i = 1}^{N} \frac{1}{A_{D_i}}\, \dpd{A_{D_i}}{{x_{\tilde{a}}^{\tilde{r} \tilde{\refl}}}} + N\, \dpd{A_I}{{x_{\tilde{a}}^{\tilde{r} \tilde{\refl}}}}} \\
%   \label{likelihood_function_re_re_deriv}
%   &= \sum_{i = 1}^{N} \frac{1}{A_{D_i}^2}\, \dpd{A_{D_i}}{{x_{\doubletilde{a}}^{\tilde{r} \tilde{\refl}}}}\, \dpd{A_{D_i}}{{x_{\tilde{a}}^{\tilde{r} \tilde{\refl}}}}
%     -\sum_{i = 1}^{N} \frac{1}{A_{D_i}}\, \dmd{A_{D_i}}{2}{{x_{\tilde{a}}^{\tilde{r} \tilde{\refl}}}}{}{{x_{\doubletilde{a}}^{\tilde{r} \tilde{\refl}}}}{}
%     + N\, \dmd{A_I}{2}{{x_{\tilde{a}}^{\tilde{r} \tilde{\refl}}}}{}{{x_{\doubletilde{a}}^{\tilde{r} \tilde{\refl}}}}{} \\
% \end{align}
