...
namespace rpwa {  
	...
	private:
		...
		double cuBreakUpMomentum(const double, const double, const double) const;
		double BFactor(int, double) const;
		int cufac(int) const;
		double cuabs( double ) const;
		int cupmo(const int) const;
		bool cuisOdd(const int) const;
		void swap( int, int) const;
		int cuReflFactor(const int, const int, const int, const int) const;
		double cucgc(int,int,int,int,int,int) const;
		double cudfunc(int,int,int,double) const;
		cuda::complex<double> cuDfunc(const int, const int, const int, const double, const double, const double) const;
		cuda::complex<double> cuSpherHarm(const int, const int, const double, const double) const;
		cuda::complex<double> cuDfuncRefl(const int, const int, const int, const int, const int, const double, const double, const double) const;
		cuda::complex<double> cuDfuncReflConj(const int, const int, const int, const int, const int, const double, const double, const double) const;
		double GammaFunc(double,double,double,double,double,int) const;
		cuda::complex<double> bwig(double,double,double,double,double,int) const;
