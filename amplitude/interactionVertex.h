...
namespace rpwa {
	...
	public:
		...
		void transformOutParticles(const ParVector<LorentzRotation>& lorentzTransforms);  ///< applies Lorentz transformations to Lorentz vectors stored in outgoing particles
