...
// void
// isobarDecayVertex2::getListOfValidDecays(vector<isobarDecayVertex2*>& d1list,
// 					vector<isobarDecayVertex2*>& d2list,
// 					vector<isobarDecayVertex2*>& outlist,
...
// void
// isobarDecayVertex2::getListOfValidDecays(vector<isobarDecayVertex2*>& outlist, 
// 					int maxl,
// 					bool blockExotic){
...
// 	  outlist.push_back(new isobarDecayVertex2(*newmo,
// 						  daughter1(),
// 						  daughter2(),l,s));
