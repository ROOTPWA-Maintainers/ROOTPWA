...
BOOST_PYTHON_MODULE(libRootPwaPy){
	...
	bp::class_< std::vector< const rpwa::particleProperties* > >("vector_less__const_rpwa_scope_particleProperties_ptr___greater_")    
		.def( bp::vector_indexing_suite< ::std::vector< const rpwa::particleProperties* > >() );
