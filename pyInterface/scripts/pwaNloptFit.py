...
if __name__ == "__main__":
	...
	parser.add_argument("--do-not-normalize-amplitudes", dest="useNormalizedAmps", action="store_false", help="do not normalize amplitudes (default: normalize amplitudes)")
