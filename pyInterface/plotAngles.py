...
def getPermutationsForIsobarCombinations(topology, isobarCombinations):
	...
	for isobarCombinationI in range(len(isobarCombinations)):
		isobar1 = topology.isobarDecayVertices()[isobarCombinations[isobarCombinationI][0]]
		isobar2 = topology.isobarDecayVertices()[isobarCombinations[isobarCombinationI][1]]
		...
		for i in range(len(keys)):
			...
			for j in range(i):
				...
				if massGroup1 == testMassGroup1 and massGroup2 == testMassGroup2:
					alreadyThere = True
					break
			permutations[permutation][isobarCombinationI] = not alreadyThere
	return permutations
