...
namespace {
	...
	rpwa::isobarDecayTopologyPtr createIsobarDecayTopology_1(const rpwa::isobarDecayTopology& topo)
	{
		return rpwa::createIsobarDecayTopology(topo);
	}

	rpwa::isobarDecayTopologyPtr createIsobarDecayTopology_2(const rpwa::decayTopology& topo)
	{
		return rpwa::createIsobarDecayTopology(topo);
	}
